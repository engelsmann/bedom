...
urlpatterns = [
    ...
    path('fg_valg_forloeb/<int:pk>/klasse', views.KlasseFormView.as_view(), name='fg_valg_forløb'),    
    path('fg_valg_modul/<int:pk>/forloeb', views.KlasseFormView(), name='fg_valg_modul'),    
]
